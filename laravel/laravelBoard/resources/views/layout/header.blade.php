<header>
    <nav class="navbar navbar-expand-lg bg-body-tertiary" data-bs-theme="dark">
        <div class="container-fluid">
            ...
            @endauth
            @guest
                <a href="{{ route('regist') }}" class="navbar-nav nav-link text-light" role="button">Sign in</a>
                {{-- <a href="{{ route('get.registration') }}" class="navbar-nav nav-link text-light" role="button">Sign in</a> --}}
            @endguest
        </div>
    </nav>
</header>